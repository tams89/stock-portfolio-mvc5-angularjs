...
namespace Krs.Ats.IBNet.Contracts
{
    ...
    public class Option : Contract
    {
        ...
        /// </summary>
        /// <param name="equitySymbol">
        /// Symbol of the equity. See <see cref="Contract.Symbol"/>.
        /// </param>
        /// <param name="optionSymbol">
        /// Symbol of the option for the underlying equity. See <see cref="Contract.LocalSymbol"/>.
        /// </param>
        /// <param name="expiry">
        /// Option Expiration String. See <see cref="Contract.Expiry"/>.
        /// </param>
        /// <param name="right">
        /// Option Right (Put or Call). See <see cref="Contract.Right"/>.
        /// </param>
        /// <param name="strike">
        /// Option Strike Price. See <see cref="Contract.Strike"/>.
        /// </param>
        ...
        /// </param>
        /// <param name="year">
        /// Option Expiration Year. See <see cref="Contract.Expiry"/>.
        /// </param>
        /// <param name="month">
        /// Option Expiration Month. See <see cref="Contract.Expiry"/>.
        /// </param>
        /// <param name="right">
        /// Option Right (Put or Call). See <see cref="Contract.Right"/>.
        /// </param>
