...
// [assembly: System.Web.PreApplicationStartMethodAttribute(typeof(Portfolio.App_Start.DependencyConfig), "PreStart")]

// When Order is not defined it defaults to -1, so -2 is used to make it run first
[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(Portfolio.App_Start.DependencyConfig), "PreStart", Order = -2)]
namespace Portfolio.App_Start
{
	internal static class DependencyConfig
	{
		public static void RegisterDependencies(IIocContainer container)
		{
		    ...
		    container.Register<IYahooFinanceService, YahooFinanceService>();
		}
