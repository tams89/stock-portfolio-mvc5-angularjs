...
(function(f) {
        ...
        contextMenu: function(c, a, d, b, f, h, g) {
            ...
            if (!i)
                e[o] = i = k("div", { className: c }, { position: "absolute", zIndex: 1E3, padding: s + "px" }, e.container), v = k("div", null, p({ MozBoxShadow: "3px 3px 10px #888", WebkitBoxShadow: "3px 3px 10px #888", boxShadow: "3px 3px 10px #888" }, j.menuStyle), i), w = function() {
                    ...
                    "mouseleave", function() { n = setTimeout(w, 500); }), t(i, "mouseenter", function() { clearTimeout(n); }), t(document, "mouseup", function(a) { e.pointer.inClass(a.target, c) || w(); }), r(a, function(a) {
                        if (a) {
    ...
    F.menu = function(c, a, d, b) { return ["M", c, a + 2.5, "L", c + d, a + 2.5, "M", c, a + b / 2 + 0.5, "L", c + d, a + b / 2 + 0.5, "M", c, a + b - 1.5, "L", c + d, a + b - 1.5]; };
